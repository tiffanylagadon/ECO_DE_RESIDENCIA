   ...
   <body>
      <div class="wrapper">
         ...
         Edit Profile
            ...
            <div class="form">
               <form action="includes/admin-editprofile-inc.php" method="post">
                  <div class="inputfield">
                     <label>First Name</label>
                     <input type="text" name="fname" class="input" value="<?php echo $_SESSION["adminFname"]; ?>">
                  </div>  
                  <div class="inputfield">
                     <label>Last Name</label>
                     <input type="text" name="lname" class="input" value="<?php echo $_SESSION["adminLname"]; ?>">
                  </div>  
                  <div class="inputfield">
                     <label>Age</label>
                     <input type="text" name="age" class="input" value="<?php echo $_SESSION["adminAge"]; ?>">
                  </div>  
                  <div class="inputfield">
                     <label>Phone Number</label>
                     <input type="text" name="pnumber" class="input" value="<?php echo $_SESSION["adminPnumber"]; ?>">
                  </div> 
                  <div class="inputfield">
                     <label>Address</label>
                     <textarea type="text" name="address" class="textarea"><?php echo $_SESSION["adminAddress"]; ?></textarea>
                  </div> 
                  <div class="inputfield">
                     <label>Gender</label>
                  ...
                  <div class="inputfield">
                     ...
                     <input type="text" name="email" class="input" value="<?php echo $_SESSION["adminEmail"]; ?>">
                  </div> 
                  <div class="inputfield">
                    ...
                    <div class="inputfield">
                  <input type="submit" formaction="admin_editpassword.php" value="Change Password"class="btn"></div>
                  <div class="inputfield">
                      <input type="submit" formaction="dashboard.php" value="Back" class="btn"></div>
               </form>
            </div>
      </div>
   </body>
