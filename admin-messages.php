        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
          ...
          <tbody>
            <?php
                ...
                $query1=mysqli_query($conn,"select * from messages");
                while($row=mysqli_fetch_array($query1))
                { 
            ?>
            <tr>
                <td><center><?php echo $row['usersName']; ?></center></td>
                <td><center><?php echo $row['usersEmail']; ?></center></td>
                <td><center><?php echo $row['usersMessage']; ?></center></td>
            <?php } ?>     
          </tbody>
        </table>
      </div>
