...
<body>
    ...
    <i class="fas fa-bars"></i>
        ...
        <ul id="menu">
            ...
            <li><a href="login.php" target="_blank"><i class="fas fa-user"></i></a></li>
        </ul>
    </nav> 
        ...
        <div class="slides">
            <div class="slide slide-1">
                <div class="slide-data">
                    ...
                    <button><a href="login.php" target="_blank">BOOK NOW</a></button>
                </div>
            </div>
    ...
    <div class="about">
        <div class="inner-section">
            ...
            <div class="skills">
                <button><a href="about.php" style="text-decoration: none; color:#2B463C;">Read More</a></button>
            </div>
        </div>
    </div>
    ...
    <div class="container">
         <div class="room">
            ...
            <div class="bottom-text">
               ...
               <div class="btn">
                  <a href="login.php" target="_blank">Book Now</a>
               </div>
            </div>
         </div>
         <div class="room">
