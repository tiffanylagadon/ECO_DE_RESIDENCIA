...
<body>
  ...
  <section class="home-section">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" >
          ...
          <tbody>
            <?php
              ...
              { 
                  $Id = $row['Id'];
                  $filename = "uploads/".$row['images'];
            ?>
              <tr>
                <td><center><?php echo '<img width="30%" src='.$filename.'>'; ?></center></td>
                <td><center><?php echo $row['roomName']; ?></center></td>
                <td><center><?php echo $row['roomRate']; ?></center></td>
                <td><center><?php echo $row['roomDescription']; ?></center></td>
                <td><center><a href="admin_edit_room.php?roomId=<?php echo $Id; ?>"><button class="button button2">Edit</button></a></center></td>
                <td><center><a href="includes/rooms-delete-inc.php?roomId=<?php echo $Id; ?>"><button class="button button3">Delete</button></a></center></td>
              </tr>
            <?php } ?>     
          </tbody>
        </table>
      ...
      <a href="admin_add_room.php"><button class="button">Add Room</button></a></center>
    </div>
  </section>
